...
function b3(){
    window.alert('This is an alert from button 3'); // window object is global scope object thus is opitional
}

function b4(){
    console.log('This is an alert from button 3'); // window object is global scope object thus is opitional
}
